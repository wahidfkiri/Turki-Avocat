...
Route::put('/dossiers/factures/{facture}', [FactureController::class, 'updateInDossier']);
Route::get('/dossiers/factures/{facture}', [FactureController::class, 'editInDossier']);
...
Route::get('/dossiers/factures/{facture}/datas', [FactureController::class, 'getData'])->name('factures.datas');
