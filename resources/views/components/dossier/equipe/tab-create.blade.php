                    ...
                    <select class="form-control search_test1" id="utilisateurList" >
                        ...
                        @foreach($users as $user)
                            <option value="{{ $user->id }}" 
                                    ...
                                    data-category="{{ $user->fonction ?? 'N/A' }}"
...
$('#confirmLinkUtilisateur').click(function() {
    ...
    addlinkedUtilisateur(intervenantId, intervenantName, intervenantCategory);
...
function addlinkedUtilisateur(userId, UserName, intervenantCategory) {
