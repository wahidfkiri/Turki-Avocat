    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- Formulaire -->
                <form action="{{ route('dossiers.tasks.store', ['dossier' => $dossier->id]) }}" method="POST" id="taskForm" enctype="multipart/form-data">
                    @csrf
...
<script>
    $(document).ready(function() {
        ...
        $('#taskModal').on('show.bs.modal', function () {
            ...
            $('button[type="submit"]').prop('disabled', false).html('<i class="fas fa-save"></i> Créer la tâche');
